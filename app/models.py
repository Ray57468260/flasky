...
class Follow(db.Model):
    """
    this table stands as third party, where follower_id refers to those follow somebody, and followed_id those are followed.
    """
...
class User(UserMixin, db.Model):
    ...
    def change_email(self, token):
        ...
        se;f.avatar_hash=self.gravatar_hash()
        db.session.add(self)
        return True
